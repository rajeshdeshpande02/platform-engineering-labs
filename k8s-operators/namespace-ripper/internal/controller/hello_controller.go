...
// +kubebuilder:rbac:groups=hello.example.com,resources=hellos,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=hello.example.com,resources=hellos/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=hello.example.com,resources=hellos/finalizers,verbs=update
...
func (r *HelloReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	for _, ns := range namespaceList.Items {
		...
		fmt.Println("Creation Timestamp: ", ns.CreationTimestamp)
		fmt.Println("Creation Timestamp: ", ns.CreationTimestamp.Add(1*time.Hour))
	}

	fmt.Printf("Hello world!, Rajesh")
